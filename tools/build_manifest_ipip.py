#!/usr/bin/env python3
"""Build website/manifest_ipip.json from scales/ipip/ OSD files.

Scans scales/ipip/ for .osd bundles and extracts metadata for the website.

Usage:
    python3 tools/build_manifest_ipip.py
"""
...
OUTPUT_FILE = REPO_ROOT / "website" / "manifest_ipip.json"
OUTPUT_WEB  = REPO_ROOT.parent / "OpenScales_web" / "manifest_ipip.json"
...
def main():
    ...
    data = json.dumps(scales, indent=2, ensure_ascii=False) + "\n"

    for out in [OUTPUT_FILE, OUTPUT_WEB]:
