#!/usr/bin/env python3
"""Build website/manifest_restricted.json from restricted/ scale directories.

Scans every restricted/{CODE}/{CODE}.json file and extracts metadata for the
OpenScales website. Writes output to website/manifest_restricted.json sorted by name.
...
SCALES_DIR  = REPO_ROOT / "scales" / "restricted"
OUTPUT_FILE = REPO_ROOT / "website" / "manifest_restricted.json"
